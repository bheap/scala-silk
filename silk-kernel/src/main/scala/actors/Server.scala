...
import com.bheap.silk.view.XmlView

/** Provides default view rendering for our Silk server actors.
  *
...
trait ViewServer {
  ...
  def render = <html><body><h1>Default view from Silk view server</h1></body></html>.toString
}
...
class PageNotFoundGETViewServer extends ViewServer {
  override def render = <html><body><h1>Page not found.  Silk can not find the page you are looking for.</h1></body></html>.toString
}
